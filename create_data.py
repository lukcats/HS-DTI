...
for dataset in datasets:
    ...
    ligands = json.load(open(fpath + "ligands_can.txt"), object_pairs_hook=OrderedDict)  # drug smiles
    proteins = json.load(open(fpath + "proteins.txt"), object_pairs_hook=OrderedDict)  # ancid ASCLL编码
    affinity = pickle.load(open(fpath + "Y","rb"), encoding='latin1')  # affinity
