...
def _cast_to_type_if_compatible(name, param_type, value):
    ...
    if issubclass(param_type, bool) != isinstance(value, bool):  # bool
        raise ValueError(fail_msg)
...
class HParams(object):
    ...
    def del_hparam(self, name):
        ...
        Args:
          name: Name of the hyperparameter.
        """
        if hasattr(self, name):  # self对象是否包含名为name的属性
            delattr(self, name)  # 删除name属性
            del self._hparam_types[name]  # 删除类型
